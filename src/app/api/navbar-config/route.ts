...
export async function PUT(request: NextRequest) {
  try {
    ...
    const updateData: Record<string, unknown> = {
      ...(workExperienceLabel !== undefined && { workExperienceLabel }),
      ...(careerSeriesLabel !== undefined && { careerSeriesLabel }),
      ...(knowledgeLabel !== undefined && { knowledgeLabel }),
      ...(knowledgeLabelFr !== undefined && { knowledgeLabelFr }),
      ...
      ...(logoFontFamily !== undefined && { logoFontFamily })
    };
    ...
    if (navbarConfig) {
      ...
      navbarConfig = await prisma.navbarConfig.create({
        data: {
          ...
          logoFontFamily: logoFontFamily || "Inter"
        }
      });
    }
