        ...
        <div className="relative w-full h-full flex items-center justify-center bg-black">
          ...
          <div className="absolute top-4 right-4 flex gap-2">
            <Button
              ...
              className="!text-white !bg-black/50 !border-0 hover:!bg-black/70 !w-10 !h-10 !rounded-full flex items-center justify-center"
              size="large"
            />
            <Button
              type="text"
              ...
              className={`!text-white !border-0 !w-10 !h-10 !rounded-full flex items-center justify-center ${
