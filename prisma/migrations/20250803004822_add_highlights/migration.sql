...
INSERT INTO "new_Media" ("certificationId", "createdAt", "educationId", "experienceId", "id", "skillId", "type", "url") SELECT "certificationId", "createdAt", "educationId", "experienceId", "id", "skillId", "type", "url" FROM "Media";
DROP TABLE "Media";
